...
import reducer, {
    ...
    deleteProduct,
    useAppSelector,
    useAppDispatch, ScheduleNewState,
} from './store'
...
injectReducer('ScheduleNew', reducer)
...
const New = () => {
    ...
    const { pageIndex, pageSize, sort, query, total } = useAppSelector(
        (state) => state.ScheduleNew.data.tableData
    )
    ...
    const usherGroupList = useAppSelector(
        (state) => state.ScheduleNew.data.usherGroupList
    )

    const loading = useAppSelector(
        (state) => state.ScheduleNew.data.loading
    )
