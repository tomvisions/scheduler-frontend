...
import {Schedule} from "@/views/ScheduleList/components/ScheduleListType";
import {
    getSchedules,
    setTableData,
    setSelectedProduct,
...
import ProductDeleteConfirmation from "@/views/ScheduleList/components/ProductDeleteConfirmation";
